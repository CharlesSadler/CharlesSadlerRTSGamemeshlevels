...
OGRE_PATHS = { "$(OGRE_HOME)", "include", "lib" }
OIS_PATHS = { "$(OGRE_HOME)", "include/OIS", "lib" }
...
--
-- CEGUI_EXTRA_PATHS = {
--     { "$(OGRE_HOME)/boost_1_47", "", "lib", "CEGUIOgreRenderer" },
--     { "$(OGRE_HOME)/boost_1_47", "", "lib", "CEGUISampleHelper" }
-- }
--
CEGUI_EXTRA_PATHS = {
}
